...
What was the most difficult part of this challenge for you and your pair?
  ...
  and then call them from within check_card. We also had a bit of trouble with spliting up the 
  digits for suming up, since first you have to turn them into strings, then join them, then split them again.
...
What concepts or learnings were you able to solidify in this challenge?
  ...
  How class methods/variables work when it comes to driver code. For a while, my pair and I were explicitly calling 
  both double and sum in our driver code, and while it seemed to be working, we were failing the tests. So the idea 
  of calling a method within another method instead of outside of the class became clearer once we realised we should 
  call them in check_card.
