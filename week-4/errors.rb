...
#While loops need to have their own end statement, while this only had an end statement for the method definition. 170 is the last line of code-the reason the error gave that line is that it went through the whole document looking for that missing "end".
...
# 4. Where is the error in the code?
#The error is in the call to cartman()
# 5. Why did the interpreter give you this error?
...
# 4. Where is the error in the code?
#The error is in the call to cartmans_phrase on line 69-wrong number of arguments
# 5. Why did the interpreter give you this error?
...
# 4. Where is the error in the code?
#The error is in the call to cartman_says on line 88-wrong number of arguments
# 5. Why did the interpreter give you this error?
...
# 4. Where is the error in the code?
#It is in the call to cartmans_lie on line 109-wrong number of arguments
# 5. Why did the interpreter give you this error?
...
Which error was the most difficult to read?
  ...
  in the error message like some others were- I realized that it was going through to the end of the file looking for the
