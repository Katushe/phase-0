...
What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  ...
  Adding the children gave me a bit of trouble, at first I tried doing terah.children.carson.name = "Carson", but it gave me an error since carson wasn't defined yet, so I changed it to terah.children.carson = {name: "Carson"} since that defines the carson object and sets the name property.

How difficult was it to add and delete properties outside of the object itself?

  I didn't find it that difficult, I think the Haverbeke book is very good at explaining how JavaScript works, and this seemed pretty straightforward after reading it.

What did you learn about manipulating objects in this challenge?

  I learned that there's two ways to assign a value to a property of an object, for example, both terah["weight"] = 125 and terah.weight = 125 work. Using square brackets reminds me more of hashes in Ruby which are very similar to objects in JavaScript, but I prefer using dot because its more succinct/requires less typing.
